...
to access a web page, be it a tablet, mobile phone, laptop and even TVs \parencite{ITU}.
...
devices mentioned \parencite{SharkiFisher}.
...
used to visit it \parencite{HimanshuNegi}.
...
of the image, again in the case if the screen becomes too small\parencite{HTML5Tutorial}.
