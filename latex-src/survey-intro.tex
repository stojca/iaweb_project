...
\propname{screen} the media type was specified and using \propname{max-width}
...
be seen, because it was decided to not be shown. If \propname{display:none} was changed to 
\propname{display:block}, our header would be visible.
