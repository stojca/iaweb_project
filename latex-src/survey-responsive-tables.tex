...
\begin{figure}[tp]
    ...
    {
    Before responsive.
    \imgcredit{How an unresponsive table looks like. Images from \href{https://css-tricks.com/responsive-data-tables/} {https://css-tricks.com/responsive-data-tables/}.
