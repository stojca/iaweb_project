...
As you scroll through the table, notice the Fixed Header 
Technique in the image below.
...
For small-sized screens, the technique that would ``kick in''
 is shown in the image below. Notice the `creeping' second `minitable'
  in the bottom part.
