...
The basic structure of an HTML table starts with the \textit{<table>}
...
tag  \textit{<tr>} is used, whereas for table header \textit{<th>} tag
is used. Normally, table headers are positioned in the center and are
bold. For table cells \textit{<td>} tag is used \parencite{AdamWood}.
